...
export const translations = {
  en: {
    ...
    'booknow.no_homestay_selected': 'No homestay selected',
    'booknow.start_adventure': 'Start your island adventure by choosing a magical homestay',
    'booknow.browse_homestays': 'Browse Island Homestays',
    'booknow.loading_booking_details': 'Loading booking details...',
    'booknow.booking_confirmed': 'Booking Confirmed!',
    'booknow.booking_success_message': 'Your booking has been successfully confirmed. Your reference number is:',
    'booknow.whats_next': 'What\'s Next?',
    'booknow.confirmation_email_sent': 'A confirmation email has been sent to your email address. If you don\'t see it, please check your spam folder.',
    'booknow.save_reference': 'Your booking reference number is {reference} - please save this for your records.',
    'booknow.property_notified': 'The property owner will be notified of your booking.',
    'booknow.view_dashboard': 'You can view your booking details in your dashboard.',
    'booknow.return_home': 'Return to Home',
    'booknow.view_bookings': 'View My Bookings',
  },
  id: {
    // Navigation
    'nav.home': 'Beranda',
