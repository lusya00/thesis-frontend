...
export const translations = {
  en: {
    ...
    'about.authentic_experiences_title': 'Authentic Island Experiences',
    'about.authentic_experiences_description': 'Immerse yourself in the genuine rhythms of island life through carefully curated experiences that connect you with local culture and natural wonders.',
    ...
    'homestays.section_description': 'Experience authentic island living in our carefully selected homestays, where local hospitality meets comfortable accommodations.',
...
'datepicker.choose_dates': 'Choose Your Dates',
'datepicker.select_dates': 'Select Your Dates',
'datepicker.selected': 'Selected',
'datepicker.unavailable': 'Unavailable',
'datepicker.past_dates': 'Past dates',
'datepicker.some_unavailable': 'Some dates unavailable',
'datepicker.unavailable_notice': 'Red dates on the calendar are already booked. Please select available dates.',
'datepicker.your_selection': 'Your Selection',
'datepicker.nights': 'nights',
'datepicker.estimated': 'Estimated',
'datepicker.cancel': 'Cancel',
'datepicker.proceed_booking': 'Proceed to Booking',
'datepicker.confirm_dates': 'Confirm Dates',
'datepicker.selected_dates': 'Selected dates',
...
'booknow.secure_payment_notice': 'Secure payment processing with island-level protection',
    
   // BookNow Page
'booknow.page_title': 'Book Your Island Paradise',
'booknow.page_subtitle': 'Complete your magical journey to {homestay} - where island dreams come true',
'booknow.page_subtitle_default': 'Find your perfect island sanctuary and begin your unforgettable Untung Jawa adventure',
...
'booknow.checking_latest_rooms': 'Checking latest magical rooms...',
...
'booknow.whats_included': 'What\'s Included:',
  ...
  id: {
    ...
    'about.authentic_experiences_title': 'Pengalaman Asli ala Pulau',
    'about.authentic_experiences_description': 'Marilah menyelami kehidupan pulau yang asli lewat pengalaman seru yang dikurasi khusus—mulai dari budaya lokal sampai keindahan alam yang memukau.',
    ...
    'homestays.section_description': 'Rasakan kehidupan pulau yang autentik di homestay pilihan kami, di mana keramahan lokal bertemu dengan akomodasi yang nyaman.',
    ...
    // What's Included
    'included.whats_included': 'Yang Termasuk:',
    'included.accommodation': 'Akomodasi pulau yang nyaman',
    'included.breakfast': 'Sarapan Indonesia harian',
    'included.wifi': 'Wi-Fi berkecepatan tinggi gratis',
    'included.beach_access': 'Akses fasilitas pantai',
    'included.support': 'Dukungan pulau 24/7',
    'included.greeting': 'Sambutan pulau selamat datang',
    
    // BookNow Page
    'booknow.page_title': 'Pesan Surga Pulau Anda',
    'booknow.page_subtitle': 'Lengkapi perjalanan ajaib Anda ke {homestay} - di mana mimpi pulau menjadi kenyataan',
    'booknow.page_subtitle_default': 'Temukan tempat perlindungan pulau sempurna Anda dan mulai petualangan Untung Jawa yang tak terlupakan',
    'booknow.secure_instant_magical': 'Aman • Instan • Ajaib',
    'booknow.booking_details': 'Detail Pemesanan',
    'booknow.complete_reservation': 'Lengkapi reservasi pelarian pulau Anda',
    'booknow.select_room': 'Pilih Kamar Pulau Anda',
    'booknow.available_for_dates': '{count} Tersedia untuk Tanggal Terpilih',
    'booknow.not_available': '{count} Tidak Tersedia',
    'booknow.checking_availability': 'Memeriksa Ketersediaan...',
    'booknow.checking': 'Memeriksa...',
    'booknow.refresh_availability': 'Segarkan Ketersediaan',
    'booknow.refreshing_availability': 'Menyegarkan ketersediaan kamar',
    'booknow.checking_latest_rooms': 'Memeriksa kamar ajaib terbaru...',
    'booknow.availability_updated': 'Ketersediaan Diperbarui!',
    'booknow.availability_refreshed': 'Ketersediaan kamar telah disegarkan dengan data terbaru.',
    'booknow.guest_information': 'Informasi Tamu',
    'booknow.continue_payment': 'Lanjutkan ke Pembayaran',
    'booknow.creating_booking': 'Membuat Pemesanan...',
    'booknow.booking_summary': 'Ringkasan Pemesanan',
    'booknow.back_to_homestay': 'Kembali ke detail homestay',
    'booknow.checkin': 'Check-in',
    'booknow.checkout': 'Check-out',
    'booknow.guests': 'Tamu',
    'booknow.nights': 'Malam',
    'booknow.price_per_night': 'Harga per malam',
    'booknow.total': 'Total',
    'booknow.whats_included': 'Yang Termasuk:',
    'booknow.included_accommodation': 'Akomodasi pulau yang nyaman',
    'booknow.included_breakfast': 'Sarapan Indonesia harian',
    'booknow.included_wifi': 'Wi-Fi berkecepatan tinggi gratis',
    'booknow.included_beach': 'Akses fasilitas pantai',
    'booknow.included_support': 'Dukungan pulau 24/7',
    'booknow.included_greeting': 'Sambutan pulau selamat datang',
    ...
    'booknow.confirmation_email_sent': 'Email konfirmasi telah dikirim ke alamat email Anda. Jika Anda tidak melihatnya, silakan periksa folder spam.',
